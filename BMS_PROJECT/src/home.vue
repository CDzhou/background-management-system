	...
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			<el-col :span="20" style="font-size:26px;">
				<img src="" class="logo"> <span><i style="color:white">商城管理系统</i></span>
			</el-col>
			<el-col :span="4" class="rightbar">
				<el-dropdown trigger="click">
                    <span class="el-dropdown-link" style="color:#c0ccda;cursor: pointer;"><img :src="this.sysUserAvatar" class="head"> 您好，{{this.sysUserName}}</span>
...
<script>
	export default {
		data() {
			return {
				sysUserName: 'CDZ',
				sysUserAvatar: './static/admin.jpg',
				form: {
					name: '',
					region: '',
					date1: '',
